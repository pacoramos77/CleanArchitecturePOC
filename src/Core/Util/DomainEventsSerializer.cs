...
public static class DomainEventsSerializer
{
                                    ...
                                    static typeInfo =>
                                    {
                                        if (typeInfo.Type == typeof(DomainEventBase))
                                        {
                                            typeInfo.PolymorphismOptions = new()
                                            {
                                                ...
                                                DerivedTypes =
                                                {
                                                    new JsonDerivedType(typeof(ToDoListCreatedEvent), typeof(ToDoListCreatedEvent).FullName!),

                                                    // new JsonDerivedType(typeof(OtherEvent), typeof(OtherEvent).FullName!),
                                                },
                                            };
                                        }
                                    },
    ...
    public static string Serialize(DomainEventBase e)
